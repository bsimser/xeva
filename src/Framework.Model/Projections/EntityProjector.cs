...
namespace XF.Model {
   public class EntityProjector<TEntity, TMessage> : IProjector, IEntityMapper, IArgumentSource {
      ...
      public ReferenceMapper<EntityProjector<TEntity, TMessage>, TRefEntity, TRefMessage> Reference<TRefEntity, TRefMessage>
         ...
         JoinRefIdx++;
         var mapper = new ReferenceMapper<EntityProjector<TEntity, TMessage>, TRefEntity, TRefMessage>(this, messageInfo, entity, path) { JoinRefIdx = JoinRefIdx, EntityLevel = JoinRefIdx };
         return mapper;
      }
      ...
      public ReferenceMapper<EntityProjector<TEntity, TMessage>, TRefEntity, TRefMessage> Reference<TRefEntity, TRefMessage>
         ...
         JoinRefIdx++;
         var mapper = new ReferenceMapper<EntityProjector<TEntity, TMessage>, TRefEntity, TRefMessage>(this, null, entity, path) { JoinRefIdx = JoinRefIdx, EntityLevel = JoinRefIdx };
         return mapper;
      }

      public ExpressionMapper<EntityProjector<TEntity, TMessage>, TEntity> Criteria() {
         var entityName = typeof(TEntity).Name;
         var mapper = new ExpressionMapper<EntityProjector<TEntity, TMessage>, TEntity>(this) { EntityName = string.Format("{0}_{1}", entityName, 0) };

         Citerion.Add(mapper);
         return mapper;
      }

      public OrderingMapper<EntityProjector<TEntity, TMessage>, TEntity> OrderBy() {
         var entityName = string.Format("{0}_{1}", typeof(TEntity).Name, 0);
         var mapper = new OrderingMapper<EntityProjector<TEntity, TMessage>, TEntity>(this, entityName);
