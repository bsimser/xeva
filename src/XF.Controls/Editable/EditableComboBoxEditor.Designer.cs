namespace XF.Controls {
   partial class EditableComboBoxEditor {
      /// <summary> 
      ...
      private void InitializeComponent() {
         ...
         this._comboValue = new System.Windows.Forms.ComboBox();
         ...
         // _comboValue
         // 
         this._comboValue.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawFixed;
         this._comboValue.FormattingEnabled = true;
         this._comboValue.ItemHeight = 13;
         this._comboValue.Location = new System.Drawing.Point(110, 1);
         this._comboValue.Name = "_comboValue";
         this._comboValue.Size = new System.Drawing.Size(215, 19);
         this._comboValue.TabIndex = 11;
         this._comboValue.Resize += new System.EventHandler(this.OnComboxResized);
         this._comboValue.SelectedValueChanged += new System.EventHandler(this.OnSelectionChanged);
         this._comboValue.DropDown += new System.EventHandler(this.OnDroppingDown);
         // 
         // EditableComboBoxEditor
         // 
         ...
         this.Name = "EditableComboBoxEditor";
      ...
      private System.Windows.Forms.ComboBox _comboValue;
   }
}
